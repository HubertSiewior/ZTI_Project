...
class Recipe(models.Model):
    ...
    def __str__(self):
        return self.dish_name + "Costs: " + self.average_price.__str__()
...
class RecipeStep(models.Model):
    ...
    def __str__(self):
        return self.description + "Time: " + self.time.__str__()
...
class Ingredient(models.Model):
    ...
    def __str__(self):
        return self.ingredient_name + "Costs: " + self.price.__str__()
